-- =====================================================
-- SAFE SCHEMA UPDATE - FOR EXISTING DATABASE
-- =====================================================
-- File ini aman untuk database yang sudah ada authentication
-- Menghindari error "policy already exists"
...
-- Insert sample coupons (only if not exists)
...
-- Insert site settings (only if not exists)
...
-- This schema is safe for existing databases with authentication
-- ✅ Drops existing policies safely
-- ✅ Creates tables only if they don't exist
-- ✅ Inserts data only if it doesn't exist (ON CONFLICT DO NOTHING)
